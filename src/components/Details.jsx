...
// image
import K1 from '../assets/houseCard.png'
  ...
  return (
    <Box sx={{py: 10}}>
      <Container>
        <CustomBox>
          <ImgContainer>
          <img src={K1} alt='house' style={{maxWidth: '100%'}} />
          </ImgContainer>
          ...
          <Box>
            ...
            <Typography sx={{fontSize: '16px', color: '#5A6473', lineHeight: '27px'}}>
              When you own a home, you commit to living in one location for a  period of time. We are here to ensure that this will be a memorable experience for you.
            </Typography>
          </Box>
        </CustomBox>
